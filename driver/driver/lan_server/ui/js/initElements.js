    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (inventory != false) {
                ...
                items.push("USB keyboard or mouse");
                var items_id = [];
                k = 0;
